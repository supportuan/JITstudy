...
export function HeroSection() {
  return (
    <VideoBackgroundLayout header={<SiteHeader />}>
      <div className="flex h-full min-h-0 flex-col items-center justify-center px-4 pt-16 pb-14 text-center md:pt-20 md:pb-16">
        <div className="flex w-full flex-col items-center max-md:gap-10 md:gap-0">
          <motion.div
            className="liquid-glass max-w-[92vw] -translate-y-2 rounded-full bg-black/10 px-3 py-1.5 font-body text-xs text-[hsl(var(--foreground)/0.9)] md:mb-6 md:translate-y-0 md:py-2 md:text-sm"
